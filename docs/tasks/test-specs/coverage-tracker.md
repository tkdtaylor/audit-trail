...
| 014 | Design log rotation | [014-design-log-rotation-test-spec.md](014-design-log-rotation-test-spec.md) | Spec complete; TC-014-01..08 defined | 🟡 | Docs review: [ADR-005](../../architecture/decisions/005-log-rotation.md) written, status Accepted; resolves all 4 forks (boundary trigger, manifest/seam tamper-evidence, parameterized walk + v1 preservation, synchronous re-anchoring), with single-writer mutex, integrity risks, and required 015–018 evidence. Design-only; no Go source modified |
