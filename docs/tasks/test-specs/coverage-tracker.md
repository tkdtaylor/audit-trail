...
| 012 | Anchoring runtime surface | [012-anchoring-runtime-surface-test-spec.md](012-anchoring-runtime-surface-test-spec.md) | Spec complete; TC-012-01..05 passed | 🟡 | L5: validation harness exercises CLI and IPC socket paths. `go test -v -run TestRekorRuntimeIntegration` -> `ok github.com/tkdtaylor/audit-trail 0.651s` |
